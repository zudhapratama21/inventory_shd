                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" method="post"
                                    ...
                                    @csrf
                                    @include('pembelian.penerimaanbarang._form-control', [
                                        'submit' => 'Save',
                                    ])
                                </form>
                            </div>
    ...
    @push('script')
        ...
        <script type="text/javascript">
            ...
            function datapesanan() {
                initializeDataTable('.yajra-datatable-pesanan', "{{ route('penerimaanbarang.datatablebarang') }}", [{
                        data: 'kode',
                        searchable: false,
                        name: 'products.kode'
                    },
            ...
            function dataterima() {
                initializeDataTable('.yajra-datatable-terima', "{{ route('penerimaanbarang.datatablebarangterima') }}", [{
                        data: 'kode',
                        searchable: false,
                        name: 'products.kode'
                    },
            ...
            function submitItem() {
                ...
                $.ajax({
                    ...
                    success: function(data) {                        
                        ...
                        $('.yajra-datatable-terima').DataTable().ajax.reload(null, false);
                        iziToast.success({
                                title: 'success',
            ...
            function hapusbarang(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: 'POST',
                            url: '{{ route('penerimaanbarang.hapusbarang') }}',
                            dataType: 'html',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                            },
