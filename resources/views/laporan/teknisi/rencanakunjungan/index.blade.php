                        ...
                        <div class="card card-custom">
                            <div class="card-header py-3">
                                <div class="card-title">
                                    ...
                                    <h3 class="card-label">Laporan Rencana Aktivitas Teknisi</h3>
                                </div>
                            </div>
        ...
        function calender() {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: function(fetchInfo, successCallback, failureCallback) {
                    $.ajax({
                        url: `{{ route('laporanrencanaaktivitasteknisi.list') }}`,
                        type: 'GET',
                        data: {
                ...
                eventClick: function({
                    ...
                    $.ajax({
                        type: 'GET',
                        url: `{{ url('laporan/laporanrencanaaktivitasteknisi') }}/${event.id}/show`,
                        headers: {
