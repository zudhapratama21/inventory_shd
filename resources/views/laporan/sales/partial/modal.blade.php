                        ...
                        <div class="modal-body">
                            <form action="">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{\Carbon\Carbon::parse($kunjungansales->jam_buat)->format('H:i')}}" readonly>
                                </div>

                                <div class="form-group">
                                    <label for="">Sales</label>
                                    <input type="text" class="form-control" value="{{$kunjungansales->user->name}}" readonly>
                                </div>

                                <div class="form-group">
                                    <label for="">Outlet</label>
                                    <input type="text" class="form-control" value="{{$kunjungansales->outlet ? $kunjungansales->outlet->nama : $kunjungansales->customer}}" readonly> 
                                </div>
