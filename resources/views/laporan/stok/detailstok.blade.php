...
@section('content')
    ...
    <div class="modal fade" id="tambahexp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="form-group">
                            ...
                            <span class="text-danger" style="font-size: 80%">*(Jika produk non expired tanggal pilih hari
                                ini !)</span>
                        </div>                       
                        <div class="form-group">
                            <label for="">Qty</label>
