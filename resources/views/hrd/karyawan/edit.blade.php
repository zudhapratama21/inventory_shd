...
@section('content')
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" method="post" action="{{ route('karyawan.update', ['id'=> $karyawan->id ]) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="no_emp" class="form-control" value="{{$karyawan->no_emp}}" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="alamat" id="" cols="30" rows="5" class="form-control">{{ $karyawan->alamat }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="jabatan_id" class="form-control" id="">
                                                    @foreach ($jabatan as $item)
                                                        @if ($karyawan->jabatan_id == $item->id)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="email" value="{{ $karyawan->email }}"
                                                    class="form-control">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="statuskaryawan_id" class="form-control" id="">
                                                    @foreach ($statuskaryawan as $item)
                                                        @if ($item->id == $karyawan->statuskaryawan_id)
                                                            <option value="{{ $item->id }}" selected>
                                                                {{ $item->nama }}
                                                            </option>
                                                        @else
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <button type="button" class="btn btn-outline-primary btn-sm"
                                                    data-toggle="modal" data-target="#ktp">
                                                    Cek Ktp
                                                </button>
    ...
    <div class="modal fade" id="profile" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="height: 300px;">
                    <iframe src="{{ asset('storage/' . $karyawan->foto_profil) }}" width="100%"
                        height="400px"></iframe>
                </div>
    ...
    <div class="modal fade" id="ktp" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body" style="height: 300px;">
                    <iframe src="{{ asset('storage/' . $karyawan->foto_ktp) }}" width="100%"
                        height="400px"></iframe>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light-primary font-weight-bold"
