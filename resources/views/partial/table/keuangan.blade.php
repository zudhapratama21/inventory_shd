        ...
        <div class="col-lg-6">
            ...
            <div class="card card-custom gutter-b ">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <button id="scroll-button" class="btn btn-primary btn-sm" onclick="document.querySelector('#target-hutang').scrollIntoView({ behavior: 'smooth' })"><i class="flaticon-more-1"></i>
                            Preview</button>
                    </div>
                </div>
                <!--end::Header-->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-striped progress-bar-animated bg-danger"
                                            role="progressbar" id="progress-jatuh-tempo" style="width: 0%" aria-valuenow="0"
        ...
        <div class="col-lg-6">
            ...
            <div class="card card-custom gutter-b ">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <button  class="btn btn-primary btn-sm" onclick="document.querySelector('#target-piutang').scrollIntoView({ behavior: 'smooth' })"><i class="flaticon-more-1"></i>
                            Preview</button>
                    </div>
                </div>
                <!--end::Header-->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-striped progress-bar-animated bg-danger"
                                            role="progressbar" id="progress-piutang-jatuh-tempo" style="width: 0%" aria-valuenow="0"
                                            aria-valuemin="0" aria-valuemax="100"></div>
                                        <div class="progress-bar progress-bar-striped progress-bar-animated bg-primary"
                                            role="progressbar" id="progress-piutang-belum-jatuh-tempo" style="width: 0%"
                                            aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card card-custom gutter-b card-stretch">
                ...
                <div class="card-body">
                    <table
                        class="table table-separate table-head-custom table-checkable table  collapsed ">
                        <thead>
                            <tr>
                                <th>Tanggal</th>
                                <th>Nama Produk</th>
