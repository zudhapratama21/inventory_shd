<div id="xcontohmodal">
    <div class="modal fade" id="modalrencanaedit" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                ...
                <div class="modal-body">                    
                    <form id="form-action">
                        <div class="form-group">
                            ...
                            <input type="date" id="tanggal" class="form-control" value="{{ $rencanakunjungan->tanggal }}" readonly>
                        </div>
