...
@section('content')
    ...
    <!-- Modal -->
    <div class="modal fade" id="importproduct" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <a href="{{ asset('producttemplate.xlsx') }}" download class="btn btn-primary btn-sm mr-2">
                                <span
                                    class="svg-icon svg-icon-default svg-icon-1x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo2\dist/../src/media/svg/icons\Files\Import.svg--><svg
