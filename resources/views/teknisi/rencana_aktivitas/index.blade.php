                    ...
                    <div class="col-lg-12">
                        <div class="card mt-10">
                            <div class="card-header">
                                <h3>Rencana Aktivitas Teknisi</h3>
                            </div>
                            <div class="card-body">
    ...
    <script type="text/javascript">
        ...
        function calender() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventLimit: true,
                navLinks: true,
                events: `{{ route('rencanaaktivitasteknisi.list') }}`,
                dateClick: function(info) {
                    $.ajax({
                        type: 'POST',
                        url: '{{ route('rencanaaktivitasteknisi.create') }}',
                        headers: {
                        ...
                        success: function(res) {
                            ...
                            $('#form-action').on('submit', function(event) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '{{ route('rencanaaktivitasteknisi.store') }}',
                                    headers: {
                ...
                eventClick: function({
                    ...
                    $.ajax({
                        type: 'GET',
                        url: `{{ url('teknisi/rencanaaktivitas') }}/${event.id}/edit`,
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        data: {
                        ...
                        success: function(res) {
                            ...
                            $('#form-action').on('submit', function(event) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '{{ route('rencanaaktivitasteknisi.update') }}',
                                    headers: {
                                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                            .attr('content')
                                    },
                            ...
                            $('#delete-btn').on('click', function(event) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '{{ route('rencanaaktivitasteknisi.delete') }}',
                                    headers: {
                                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                            .attr('content')
                                    },
