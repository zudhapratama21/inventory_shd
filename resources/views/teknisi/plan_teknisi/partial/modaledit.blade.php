                ...
                <div class="modal-body">
                    @if ($terlambat == 1)
                        <div class="text-center">
                            <span class="badge badge-danger">Bulan Sudah terlewat , mohon maaf tidak bisa mengubah
                                data Plan</span>
                        </div>
                        ...
                        <form id="form-action">
                            <div class="form-group">
                                ...
                                <input type="date" id="tanggal" class="form-control"
                                    value="{{ $planteknisi->tanggal }}" readonly>
                            </div>

                            <input type="hidden" id="data_id" value="{{ $planteknisi->id }}">

                            <div class="form-group">
                                <label for="">Outlet</label> <br>
                                <select name="" id="kt_select2_4" class="form-control" required>
                                    @foreach ($outlet as $item)
                                        @if ($planteknisi->outlet_id == $item->id)
