    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <select name="outlet_id" class="form-control" id="kt_select2_2" required>
                @if ($kunjungan->customer)
                    <option value="0" selected disabled>{{ $kunjungan->customer }}</option>
        ...
        <div class="form-group">
            ...
            <textarea type="text" name="aktifitas" value="" class="form-control" placeholder="Masukkan aktifitas"
                id="" cols="30" rows="5">{{ $kunjungan->aktifitas }}</textarea>
        ...
        <div class="form-group">
            <div class="col-md-2 mb-4">
                ...
                <a href="#" data-toggle="modal" data-target="#fotokunjungan">
                    <img src="{{ asset('storage/kunjunganteknisi/' . $kunjungan->image) }}" class="img-fluid"
                        alt="">
                </a>
            </div>
