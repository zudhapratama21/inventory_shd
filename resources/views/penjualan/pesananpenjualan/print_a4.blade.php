...
<body style="font-family: sans-serif;position: relative;">
    @for ($i = 1; $i <= $totalPage; $i++)
        <table width="100%" style="margin-top: 0px">
            <tr>
                <td width="40%" style="font-size: 70%; vertical-align: top;">
                    ...
                    <p>
                        Juanda Regency Blok H-06, JL. Raya Bypass Juanda NO.11, <br> Pabean-Sedati, Sidoarjo,
                        Kode Pos 61253.
                    </p>
                ...
                <td width="40%" style="vertical-align: top; font-family: sans-serif; ">
                    <table style="width: 100%;">
                        ...
                        <tr style="padding:0px;">
                            <td style="padding:0px; font-size: 70%;" colspan="3">
                                {{ $pesananpenjualan->customers->nama }}
                            </td>
                        </tr>
                        <tr style="padding:0px;">
                            <td style="padding:0px; font-size: 70%;" colspan="3">
                                {{ $pesananpenjualan->customers->alamat }}, Blok
                                {{ $pesananpenjualan->customers->blok }}, No. {{ $pesananpenjualan->customers->nomor }},
            ...
            <tr>
                <td width="20%" style="font-size: 70%; vertical-align: top;">
                    ...
                    Tanggal Pesanan :
                    {{ $pesananpenjualan->tanggal_pesanan_customer ? \Carbon\Carbon::parse($pesananpenjualan->tanggal_pesanan_customer)->format('d/m/Y') : '-' }}
                </td>
        ...
        <table width="100%">
            <tr>
                <td colspan="6" style="width:100%;vertical-align: top;display: flex">
                ...
                @if ($i == $totalPage)
                    <td style="text-align: right">
                        <table width="100%">
                            ...
                            <tr>
                                <td style='font-size: 70%; width: 75%;'><b>PPN ({{ $pesananpenjualan->ppn }}) %</b>
                                </td>
                                <td style='font-size: 70%; width: 5%;'><b>: Rp.</b></td>
                        ...
                        <table>
                            <tr>
                                <td style="font-size: 70%;">SO Cust. :
                                    {{ $pesananpenjualan->no_so_customer ? $pesananpenjualan->no_so_customer : '-' }}
                                </td>
                            </tr>
                        </table>
                        <br />
                        <table width="100%">
                            <tr>
                                ...
                                <td style='font-size: 70%; width: 55%; line-height:90%; vertical-align:top'>
                                    <b>KETERANGAN : <br />{{ $pesananpenjualan->keterangan }}</b>
