                        ...
                        <div class="tab-pane fade show active" id="kt_tab_pane_1_3" role="tabpanel"
                            ...
                            <form class="form">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="hargajual" name="hargajual"
                                                value="{{$hargaProduk ? number_format($item->hargajual, 0, ',', '.') : 0}}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label">PPN Ongkir(%) * (KHUSUS
                                            E-KATALOG)</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="ppn_ongkir"
                                                name="ppn_ongkir" value="0" />
                                        </div>
                                    </div>
                    ...
                    <form class="form">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="hargajual" name="hargajual"
                                        value="{{ number_format($item->hargajual, 12, ',', '.') }}" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label">PPN (%) * (KHUSUS E-KATALOG)</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="ppnprice" name="ppnprice"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="ppn_ongkir" name="ppn_ongkir"
                                        value="0" />
                                </div>
                            </div>
