...
@section('content')
    ...
    <div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" method="post" action="{{ route('fakturpenjualan.store') }}">
                                    @csrf
                                    @include('penjualan.fakturpenjualan._form-control', [
                                        'submit' => 'Save',
                                    ])
                                </form>
                            </div>
        ...
        @include('penjualan.fakturpenjualan.modal.carisj')
        ...
        <script type="text/javascript">
            ...
            function datatablepengiriman() {
                var table = $('.yajra-datatable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('fakturpenjualan.datatablelistsj') }}",
                        type: "POST",
                    ...
                    columns: [{
                            ...
                            render: function(data, type, row) {
                                return `<input type="checkbox" class="sj-checkbox" value="${data}">`;
                            }
                        },
                        {
                            data: 'kode',
            ...
            function simpansj() {
                ...
                $('.sj-checkbox:checked').each(function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('fakturpenjualan.simpansj') }}',
                    dataType: 'json',
                    headers: {
                    ...
                    success: function(data) {
                        ...
                        iziToast.success({
                            title: 'success',
                            message: 'Data Surat Jalan Berhasil Dipilih',
                            position: 'topRight',
                        });
            ...
            function databarang() {
                var table = $('.yajra-datatable-databarang').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('fakturpenjualan.loadsj') }}",
                    columns: [{
                            data: 'nama',
                            name: 'nama'
                        },
            ...
            function editsj(id) {
                $.ajax({
                    type: 'POST',
                    url: '{{ route('fakturpenjualan.editsj') }}',
                    dataType: 'html',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function updatesj() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('fakturpenjualan.updatesj') }}',
                    dataType: 'json',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function hapussj(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: 'POST',
                            url: '{{ route('fakturpenjualan.hapussj') }}',
                            dataType: 'json',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                            },
            ...
            function submititem() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('fakturpenjualan.simpanbarang') }}',
                    dataType: 'json',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function hitungtotal() {
                $.ajax({
                    type: 'GET',
                    url: "{{ route('fakturpenjualan.hitungtotal') }}",
                    dataType: 'json',
            ...
            function submitbiaya() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('fakturpenjualan.simpanbiaya') }}',
                    dataType: 'json',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function submitfj() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('fakturpenjualan.storefj') }}',
                    dataType: 'json',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
