                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Input Produk </h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post"
                                action="{{ route('pengirimanbarang.saveproduk', ['stokproduk'=>$stokproduk,'pengirimanbarangdetail'=> $pengirimanbarangdetail]) }}">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly="readonly" name="stok" value="{{ $stokproduk->harga_beli }}" class="form-control" />
                                        @error('stok')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly="readonly" name="stok" value="{{ $stokproduk->diskon_persen }}" class="form-control" />
                                        @error('stok')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        <label>Diskon Beli (Rp.) :</label>
                                        <input type="text" readonly="readonly" name="stok" value="{{ $stokproduk->diskon_rupiah }}" class="form-control" />
                                        @error('stok')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly="readonly" name="stok" value="{{ $stokproduk->qty }}" class="form-control" />
                                        @error('stok')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
